...
-- DEPT와 유사한 DEPT01 생성 : DEPTNO(수2-PK), DNAME(문14), LOC(문13)
CREATE TABLE DEPT01(
...
SELECT * FROM DEPT01;
ROLLBACK; -- DML취소
-- EMP와 유사한 EMP01 생성 : EMPNO(수4-PK), ENAME(문10), HIREDATE(날), SAL(수7.2), DEPTNO(수2-FK)
CREATE TABLE EMP01(
...
COMMIT; -- 트랜잭션 영역에 쌓여 있는 DML명령어들을 ORACLE 일괄 적용
...
-- 서브쿼리(10번 부서인 EMP테이블 EMPNO, ENAME, JOB, SAL내용)를 이용한 3행 INSERT
INSERT INTO SAM01 SELECT EMPNO, ENAME, JOB, SAL FROM EMP WHERE DEPTNO=10;
-- 트랙잭션에 쌓여있는 DML 오라클 적용시키기
COMMIT;
...
SELECT * FROM EMP01;
    ...
    SELECT * FROM EMP01;
    ROLLBACK;
    -- EX. 모든사원(EMP01)의 급여(SAL)를 10%인상
...
DROP TABLE MAJOR;
CREATE TABLE MAJOR(
    MCODE NUMBER(1) PRIMARY KEY NOT NULL,
    MNAME VARCHAR2(15),
    MOFFICE VARCHAR2(15)
);
DROP TABLE STUDENT;
